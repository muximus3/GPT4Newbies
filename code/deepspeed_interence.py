...
import torch
import time
from deepspeed_interence_utils import DSPipeline
from deepspeed.runtime.utils import see_memory_usage

parser = ArgumentParser()

parser.add_argument("--model_name_or_path", required=True, type=str, help="model_name")
parser.add_argument("--tokenizer_name_or_path", required=True, type=str, help="model_name")
...
parser.add_argument("--max_new_tokens", default=250, type=int, help="maximum new tokens to generate")
...
t0 = time.time()
pipe = DSPipeline(model_name=args.model_name_or_path,
